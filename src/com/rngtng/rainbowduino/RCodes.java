...
public interface RCodes {
    ...
    /* Display Control */
    public final static int RESET = 254; // returns OK + current frame which
                                         // should be 0
    public final static int START = 218; // returns OK + current frame
    public final static int STOP = 216; // returns OK + current frame
    public final static int FRAME_SET = 214; // param: frame nummer, returns OK
                                             // + current frame
    public final static int FRAME_GET = 212; // returns OK + current frame

    /* Display Control */
    public final static int BRIGHTNESS_SET = 208; // param: brightness, returns
                                                  // OK + current frame
    public final static int BRIGHTNESS_GET = 206; // returns OK + brightness
                                                  // color

    /* Buffer Control */
    // XY
    // Y
    public final static int BUFFER_SET_AT = 246; // param: buffer addr, returns
                                                 // OK + buffer size
    // param2: buffer content, returns OK

    public final static int BUFFER_GET_AT = 244; // param: buffer addr, returns
                                                 // OK + buffer size
    ...
    /* Speed Control */
    public final static int SPEED_SET = 228; // param: SPEED value, returns OK +
                                             // speed value
